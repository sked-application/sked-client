        ...
        <div className="header">
            <div className="container">
                <div className="header__content">
                    ...
                    {!isAuthenticated && !['/sign-in', '/customer-sign-in', '/sign-up', '/recover-password', '/reset-password'].some((state) => currentPathname.includes(state)) && (
						<Link to={`/sign-in`} className="header__action">Sou profissional</Link>
					)}

					{!isAuthenticated && ['/sign-in'].includes(currentPathname) && (
						<Link to={`/customer-sign-in`} className="header__action">Sou cliente</Link>
					)}
