...
import TimegridWeekDay from '../timegrid-week-day/timegrid-week-day';
import TimegridService from '../../../../services/timegrid';
import schema from './settings-timegrid-form-schema-validator';
					...
					>
						...
						<div className="setting-slot__box flexbox flexbox--wrap">
							{formData.map((item, index) => (
								<div
									key={index}
									className={`setting-slot__item flexbox m-t-15 p-l-5 p-r-5`}
